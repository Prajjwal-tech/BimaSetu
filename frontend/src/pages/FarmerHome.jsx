...
function damageBadgeClass(pct) {
  if (pct < 30) return 'text-green-400 bg-green-500/15 border-green-500/30'
...
export default function FarmerHome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0A120E] via-[#0D1811] to-[#0A120E] relative overflow-hidden">
      <div
        className="farmer-orb absolute -top-24 -right-24 w-72 h-72 rounded-full bg-emerald-600/20 blur-3xl pointer-events-none"
        aria-hidden
      />
      <div
        className="farmer-orb absolute bottom-20 -left-16 w-56 h-56 rounded-full bg-amber-500/10 blur-3xl pointer-events-none"
        style={{ animationDelay: '2s' }}
        aria-hidden
      />

      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-8">
        <header className="farmer-enter mb-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div>
              <div className="flex flex-wrap items-center gap-3 mb-3">
                <span className="inline-flex items-center gap-2 text-emerald-400 text-sm px-3 py-1 rounded-full border border-emerald-800/60 bg-emerald-950/50">
            ...
            <button
              type="button"
              onClick={() => navigate('/dashboard')}
              className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-amber-500 text-black font-bold hover:bg-amber-400 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-amber-500/25 shrink-0"
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8 farmer-enter">
          {statCards.map((s) => (
            <button
              ...
              className={`group rounded-2xl p-4 text-left transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-500/10 focus:outline-none focus:ring-2 focus:ring-amber-500/40 ${
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <ArrowUpRight
                  className={`w-4 h-4 text-gray-600 transition ${
                    hoveredStat === s.id ? 'text-amber-400 translate-x-0.5 -translate-y-0.5' : ''
                  }`}
                />
              </div>
              ...
              <p className="text-[10px] text-emerald-600 mt-2 opacity-0 group-hover:opacity-100 transition sm:opacity-100 sm:text-gray-600">
          ...
          <div className="rounded-2xl p-6 flex items-center gap-6" style={cardStyle}>
            <div className="relative w-24 h-24 shrink-0">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                <circle cx="50" cy="50" r="42" fill="none" stroke="rgba(16,50,30,0.8)" strokeWidth="10" />
                <circle
                  cx="50"
                  cy="50"
                  r="42"
            ...
            <div>
              <h3 className="text-lg font-bold text-white mb-1">{t('farmerHome.completionRate')}</h3>
              ...
              <button
                ...
                className="mt-3 text-sm text-emerald-400 hover:text-amber-400 flex items-center gap-1"
              >
              ...
              {damageBreakdown.map((d) => (
                ...
                >
                  <div className="flex justify-between text-xs mb-1">
                    <span className="text-gray-400 capitalize group-hover:text-white transition">
                  ...
                  <div className="h-2 rounded-full bg-emerald-950 overflow-hidden">
                    <div
                      className="h-full rounded-full bg-gradient-to-r from-emerald-600 to-amber-500 transition-all duration-700 group-hover:from-amber-500 group-hover:to-amber-400"
                      style={{ width: `${d.pct}%` }}
                    />
                  </div>
                </button>
        ...
        <section id="how-it-works" className="mb-10 farmer-enter">
          <div className="max-w-4xl mx-auto text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{t('farmerHome.howWorks')}</h2>
              ...
              return (
                <button
                  ...
                  className={`relative rounded-2xl p-6 h-full text-left transition-all duration-300 ${
                    active
                      ? 'ring-2 ring-amber-500/70 -translate-y-1 shadow-xl shadow-amber-500/10'
                      : 'hover:-translate-y-0.5 hover:border-emerald-600/50'
                  }`}
                  style={cardStyle}
                >
                  <span
                    className={`absolute -top-3 -left-3 w-10 h-10 rounded-full font-bold flex items-center justify-center text-sm transition ${
                      active ? 'bg-amber-500 text-black scale-110' : 'bg-emerald-800 text-emerald-200'
                    }`}
                  >
                    {i + 1}
                  </span>
                  <Icon className={`w-8 h-8 mb-4 mt-2 ${active ? 'text-amber-400' : 'text-emerald-400'}`} />
          ...
          >
            ...
            <button
              ...
              className="shrink-0 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-amber-500 text-black font-semibold hover:bg-amber-400 transition"
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                activeTab === tab.id
                  ...
                  : 'bg-emerald-950/60 text-gray-400 border border-emerald-800/50 hover:text-white hover:border-emerald-600'
              }`}
            >
        ...
        <div className="space-y-6 farmer-enter">
            ...
            <>
              <div className="grid sm:grid-cols-3 gap-4">
                {quickActions.map((action) => (
                  <button
                    ...
                    className={`rounded-2xl p-5 text-left transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl ${action.glow}`}
                    style={{
                      ...cardStyle,
                      transform:
                        hoveredAction === action.id ? 'translateY(-8px) scale(1.02)' : undefined,
                    }}
                  >
                    <div
                    ...
                    <ChevronRight
                      className={`w-4 h-4 text-amber-500 mt-3 transition-all ${
              ...
              <div className="rounded-2xl p-6" style={cardStyle}>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-white">{t('farmerHome.latestActivity')}</h3>
                  <button
                    type="button"
                    onClick={() => setActiveTab('claims')}
                    className="text-sm text-emerald-400 hover:text-amber-400"
                  >
                      ...
                      return (
                        <li key={claim.id}>
                          <button
                            ...
                            className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-emerald-900/40 transition text-left"
                          >
                            <FileText className="w-5 h-5 text-amber-400 shrink-0" />
                            <div className="flex-1 min-w-0">
                              <p className="text-white text-sm truncate capitalize">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      className="p-1.5 rounded-lg hover:bg-emerald-800/40 text-gray-400 hover:text-white transition"
                    >
                ...
                <p
                  key={tipIndex}
                  className="text-gray-300 text-sm leading-relaxed animate-[farmer-fade-up_0.4s_ease-out]"
                >
                  {TIPS[tipIndex]}
                </p>
                  ...
                  {TIPS.map((_, i) => (
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all ${
                        i === tipIndex ? 'w-8 bg-amber-500' : 'w-2 bg-emerald-800 hover:bg-emerald-600'
                      }`}
                    />
                  ))}
                </div>
          ...
          {activeTab === 'claims' && (
            <div className="rounded-2xl p-6" style={cardStyle}>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <h2 className="text-xl font-bold text-white">{t('farmerHome.recentClaims')}</h2>
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-medium capitalize transition ${
                        claimFilter === f
                          ...
                          : 'bg-emerald-950/60 text-gray-400 border border-emerald-800/50 hover:text-white'
                      }`}
                    >
                      {filterLabel(f)}
                    </button>
              ...
              <button
                type="button"
                onClick={handleRefresh}
                className="text-sm text-emerald-400 hover:text-amber-400 flex items-center gap-1 mb-4"
              >
                <RefreshCw className={`w-4 h-4 ${refreshSpin ? 'animate-spin' : ''}`} />
                {t('common.refresh')}
              </button>
              ...
              {claimsLoading ? (
                ...
                <div className="text-center py-12">
                  <ImageIcon className="w-14 h-14 text-emerald-700 mx-auto mb-4" />
                      ...
                      <li
                        ...
                        className={`rounded-xl border transition-all duration-300 overflow-hidden ${
                          open
                            ...
                            : 'border-emerald-800/40 bg-emerald-950/20 hover:border-emerald-600/50'
                        }`}
                      >
                        <button
                          type="button"
                        ...
                        >
                          <div className="w-10 h-10 rounded-lg bg-emerald-800/40 flex items-center justify-center shrink-0">
                        ...
                        {open && (
                          <div className="px-4 pb-4 pt-0 border-t border-emerald-800/30 animate-[farmer-fade-up_0.3s_ease-out]">
                            <div className="grid sm:grid-cols-2 gap-3 text-sm text-gray-400 mb-3">
                              <p>
                                <span className="text-gray-500">{t('farmerHome.type')}:</span>{' '}
                                {claim.damage_type || '—'}
                              </p>
                              <p>
                                <span className="text-gray-500">{t('farmerHome.confidence')}:</span>{' '}
                                {claim.confidence
                              ...
                              <p>
                                <span className="text-gray-500">{t('farmerHome.status')}:</span>{' '}
                            ...
                            {claim.pdf_url && (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-500/20 text-amber-400 hover:bg-amber-500/30 text-sm transition"
                              >
          ...
          {activeTab === 'guide' && (
            <div className="rounded-2xl p-6" style={cardStyle}>
              <h2 className="text-xl font-bold text-white mb-2">{t('farmerHome.claimPipeline')}</h2>
              <p className="text-gray-400 text-sm mb-6">{t('farmerHome.pipelineClick')}</p>
                  ...
                  <React.Fragment key={step.id}>
                    <button
                      ...
                      className={`flex-1 flex flex-col items-center p-4 rounded-xl transition-all duration-300 ${
                        activeStep === i
                          ? 'bg-amber-500/20 border-2 border-amber-500/60 scale-[1.02]'
                          : 'bg-emerald-950/30 border border-transparent hover:bg-emerald-900/40'
                      }`}
                    >
                      <step.icon
                        className={`w-8 h-8 mb-2 ${
                          activeStep === i ? 'text-amber-400' : 'text-emerald-500'
                        }`}
                      />
              ...
              <div
                key={activeStep}
                className="rounded-xl p-5 bg-emerald-950/50 border border-emerald-800/40 animate-[farmer-fade-up_0.35s_ease-out]"
              >
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <button
                        type="button"
                        onClick={() => navigate('/dashboard')}
                        className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-emerald-600 text-white text-sm font-semibold hover:bg-emerald-500 transition"
                      >
